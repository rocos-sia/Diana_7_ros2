...
DIANA_API int setFunctionOptI4(/*IN*/ int intFunctionIndex, /*IN*/ int intOptName, /*IN*/ int intOptVal,
                               /*IN*/ const char *strIpAddress = "");
DIANA_API int enterSafetyIdle(const char *strIpAddress = "");
DIANA_API int leaveSafetyIdle(const char *strIpAddress = "");
...
/*************************************** version new toDecide***************************************/

DIANA_API int setHeartbeatParam(/*IN*/int disconnectTimeout, /*IN*/int stopRobotTimeout, /*IN*/const char *strIpAddress = "");

DIANA_API int getHeartbeatParam(/*OUT*/ int *disconnectTimeout, /*OUT*/ int *stopRobotTimeout, /*IN*/const char *strIpAddress = "");

DIANA_API int customRobotState(/*IN*/int action, /*IN*/unsigned long long customBits, /*IN*/const char *strIpAddress = "");

DIANA_API int getCustomRobotState(/*OUT*/ unsigned long long * customBits,  /*IN*/const char *strIpAddress = "");

DIANA_API int getTcpPoseByTcpName(/*IN*/ const char *tcpName, /*OUT[6]*/ double *coordinate,  /*IN*/const char *strIpAddress = "");

DIANA_API int getTcpPoseByWorkPieceName(/*IN*/ const char *workPieceName, /*OUT[6]*/ double *coordinate,  /*IN*/const char *strIpAddress = "");

DIANA_API int getPayLoadByTcpName(/*IN*/ const char *tcpName, /*OUT[10]*/ double *payload,  /*IN*/const char *strIpAddress = "");
